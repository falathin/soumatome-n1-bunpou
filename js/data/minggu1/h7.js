window.W1H7 = {
  ...
  exam: {
    ...
    questions: [
      ...
      {
        question: '外食した ___ ことにして ___ その分を貯めた ___ とすれば かなりの額になるだろう。',
        options: [
          '1 その分を貯めた',
          '2 ことにして',
          '3 とすれば',
      ...
      {
        question: 'その政治家は、国民の信頼を ___ 裏切ったりする ___ ことの ___ ないように ___ 心がける ことを約束した。',
        options: [
          '1 ことの',
          '2 裏切ったりする',
          '3 心がける',
      ...
      {
        question: '彼は簡単だと ___ 言うが ___ やったことがない ___ 私に ___ 言わせれば、不可能としか思えない。',
        options: [
          '1 言うが',
          '2 私に',
          '3 やったことがない',
      ...
      {
        question: '留学生の多くが、程度の違い ___ こそあれ ___ 言葉の問題 ___ に悩まされている ___ とみえる。',
        options: [
          '1 とみえる',
          '2 に悩まされている',
          '3 言葉の問題',
      ...
      {
        question: 'うちの息子は ___ 天気が悪い ___ とみると ___ 学校へ行く ___ 気が失せる ようで困ったものだ。',
        options: [
          '1 天気が悪い',
          '2 気が失せる',
          '3 とみると',
